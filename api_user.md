...
| 接口地址 | 说明 |
|---------|-----|
<del> [/user/send_code](#post-usersend_code) </del>|<del> 向手机发送验证码 | </del>
<del> [/user/verify_code](#post-userverify_code) </del>|<del> 验证验证码 |</del>
...
<del> [/user/reset_password](#post-userreset_password) </del>|<del> 通过手机验证码设置新密码 |</del>
<del> [/user/change_password](#post-userchange_password) </del>|<del> 当前登录用户通过旧密码设置新密码 |</del>
...
<del> [/user/get_image_token](#post-userget_image_token) </del>|<del> 获取云存储所用 Token |</del>
<del> [/user/get_sms_img_code](#post-userget_sms_img_code) </del>|<del> 获取短信图形验证码 |</del>
